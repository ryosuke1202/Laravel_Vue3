                                            ...
                                            <div class="flex flex-wrap -m-2">
                                                ...
                                                <div class="p-2 w-full">
                                                    <div class="relative">
                                                        ...
                                                        <Modal @update:customerId="setCustomerId"/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="p-2 w-full">
                                                    <button class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 text-lg">登録する</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
