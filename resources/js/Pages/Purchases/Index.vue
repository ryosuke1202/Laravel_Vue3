                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 bg-white border-b border-gray-200">
                            <section class="text-gray-600 body-font">
                                <div class="container px-5 py-8 mx-auto">
                                    ...
                                    <div class="lg:w-2/3 w-full mx-auto overflow-auto">
                                        <table class="table-auto w-full text-left whitespace-no-wrap">
                                            ...
                                            <tbody v-for="order in props.orders.data" :key="order.id">
                                                <tr>
                                                    <td class="px-4 py-3"><Link :href="route('purchases.show', { purchase: order.id })" class="text-blue-400">{{ order.id }}</Link></td>
                                ...
                                <Pagination class="mt-6 flex justify-center items-center" :links="props.orders.links"></Pagination>
                            </section>
                        </div>
                    </div>
                </div>
